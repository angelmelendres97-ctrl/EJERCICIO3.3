drop procedure sp_estado_cuenta_clie_fact;
--execute procedure sp_estado_cuenta_clie_fact(1, 9816, '08/26/2019', '08/26/2019', 1, 1, '%', '%', '%', '%', '%')
create procedure "informix".sp_estado_cuenta_clie_fact( in_empr integer,  in_cli integer, in_fecha_ini date, in_fecha_fin date ,
...
FOREACH 
	...
	order by  saeclpv.clpv_cod_clpv, saedmcc.dmcc_num_fac, saedmcc.dmcc_fec_emis, saedmcc.dmcc_cre_ml
